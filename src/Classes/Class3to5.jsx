            ...
            <div className='flex md:flex-row flex-col-reverse gap-5 mt-10 mb-10 '>
                ...
                <div className='flex flex-col gap-y-5'>
                    ...
                    <div className='space-y-5'>
                        ...
                        <div className='border border-2 flex flex-col gap-y-3 rounded-md md:p-5 p-2'>
                            <div className='md:grid md:grid-cols-2 grid grid-cols-1 gap-x-5 gap-y-2'>
                                <ClassTeacher
                                    Image="public/Image/Tasin.png"
                                    Name="Tasin Ibrahim"
                                    Qualification="Honours In Social Science,BL College Khulna."
                                />
                                <ClassTeacher
                                    Image="public/Image/ziadSir.png"
                                    Name="Nazim Hasan Ziad"
                                    Qualification="MBBS,Khulna City Medical College,Khulna."
                                />
                            </div>
                            <div className='md:grid md:grid-cols-2 grid grid-cols-1 gap-x-5 gap-y-2'>
                                <ClassTeacher
                                    Image="public/Image/sabbirSir.png"
                                    Name="Sabbir Ahmmed"
                                    Qualification="BA & MA in Bangla,Rajshahi University."
                                />
                                <ClassTeacher
                                    Image="public/Image/moshiurSir.png"
                                    Name="Md.Moshiur Rahman"
                                    Qualification="Bsc In Physics,BL College Khulna,."
                                />
                            </div>
                            <div className='md:grid md:grid-cols-2 grid grid-cols-1 gap-x-5 gap-y-2'>
                                <ClassTeacher
                                    Image="public/Image/Shabaz.png"
                                    Name="Md.Shahbaz Hossain"
                                    Qualification="MA in Mathematics, Rajshahi University."
                                />
                                <ClassTeacher
                ...
                <div className='lg:w-1/3'>
                    <div className='sticky top-0 space-y-3'>
                        <ClassCard1 
                        image="public/Image/Class3-5.png"/>
